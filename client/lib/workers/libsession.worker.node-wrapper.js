'use strict';
/**
 * Node.js worker_threads bridge for the webpack-compiled libsession worker.
 *
 * The compiled bundle (libsession.worker.compiled.js) was built for Electron's
...
require('./libsession.worker.compiled.js');
