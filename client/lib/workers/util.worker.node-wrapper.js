'use strict';
/**
 * Node.js worker_threads bridge for the webpack-compiled util worker.
 *
 * The compiled bundle (util.worker.compiled.js) was built for Electron's
...
require('./util.worker.compiled.js');
